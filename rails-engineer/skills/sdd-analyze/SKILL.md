...
name: sdd-analyze
description: >-
  Perform a non-destructive cross-artifact consistency and quality analysis across
  spec.md, plan.md, and tasks.md after task generation. Use after sdd-tasks, before
  sdd-implement, to catch drift between the artifacts. WHEN NOT: No tasks.md exists
  yet; already executing the plan — use sdd-implement.
---
...
The user's request from the invoking message.
