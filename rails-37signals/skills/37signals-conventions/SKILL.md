...
description: >-
  ...
  when the user asks what the conventions are. WHEN NOT: working in a project that uses the layered
  profile with app/services and RSpec — that is the rails-layered plugin, and the two must not be
  mixed.
---
