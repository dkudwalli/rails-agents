...
|-------|-----------|-------|--------------|
| Model | Unit | Validations, scopes, enums, callbacks | [`model-patterns`](../../model-patterns/references/testing-and-factories.md) |
...
Factory conventions and traits: [`model-patterns`](../../model-patterns/references/testing-and-factories.md)
