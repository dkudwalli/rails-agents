...
description: >-
  Writes Stimulus controllers with targets, values, actions, and outlets for client-side behaviour Turbo alone cannot express. Use when adding interactive JavaScript, keyboard handling, debouncing, or third-party JS integration. WHEN NOT: Server-rendered partial updates, which belong to Turbo (see turbo-patterns), or pure CSS interactions.
license: MIT
