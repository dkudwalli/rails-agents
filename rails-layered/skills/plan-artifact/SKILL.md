...
The plan is whatever the user named in the invoking message — normally a path to a local file.

If they named nothing, or what they named is not a readable local file, ask for the file path and
stop.
