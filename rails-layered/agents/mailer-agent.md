...
Four standard patterns. See [patterns.md](../skills/mailer-patterns/references/patterns.md) for full implementations:
...
- [patterns.md](../skills/mailer-patterns/references/patterns.md) -- Mailer implementation patterns
- [templates.md](../skills/mailer-patterns/references/templates.md) -- HTML/text layout and template examples
- [tests.md](../skills/mailer-patterns/references/tests.md) -- RSpec mailer tests
- [previews.md](../skills/mailer-patterns/references/previews.md) -- ActionMailer preview examples
