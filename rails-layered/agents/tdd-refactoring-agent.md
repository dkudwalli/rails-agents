...
This is a catalogue, not a running order. Refactoring a whole existing application rather than one
file? The phases are in [legacy-migration](../skills/legacy-migration/SKILL.md). Do not invent a
second ordering here.

Eight proven patterns with before/after examples in [patterns.md](../skills/tdd-refactoring/references/patterns.md):
...
See [output-format.md](../skills/tdd-refactoring/references/output-format.md) for the standard completion summary template.

## References

- [patterns.md](../skills/tdd-refactoring/references/patterns.md) -- Eight refactoring patterns with before/after Ruby examples
- [output-format.md](../skills/tdd-refactoring/references/output-format.md) -- Standard template for reporting completed refactoring
