...
Always start with mobile styles, then layer breakpoints for larger screens — the unprefixed class is
the mobile case, and each prefix widens from there
(`grid-cols-1 md:grid-cols-2 lg:grid-cols-3`). See
[component-patterns.md](../skills/tailwind-patterns/references/component-patterns.md).
...
- [component-patterns.md](../skills/tailwind-patterns/references/component-patterns.md) -- Complete implementations of buttons, forms, cards, alerts, badges, loading states, Turbo integration, and real-world examples
