...
## Form Patterns
See [form-patterns.md](../skills/form-patterns/references/form-patterns.md) for full implementations:
...
All patterns extend `ApplicationForm`, whose `save` validates first, delegates to a subclass
`persist!`, and converts a raised `ActiveRecord::RecordInvalid` into a `:base` error rather than
letting it escape — so callers only ever branch on `true`/`false`. See
[form-patterns.md](../skills/form-patterns/references/form-patterns.md).

## Testing
See [testing-and-views.md](../skills/form-patterns/references/testing-and-views.md) for complete specs and view examples.
...
Controllers use `#save` / re-render; views use `form_with model: @form`. See [testing-and-views.md](../skills/form-patterns/references/testing-and-views.md).
...
## References
- [form-patterns.md](../skills/form-patterns/references/form-patterns.md) -- ApplicationForm base class and 4 patterns
- [testing-and-views.md](../skills/form-patterns/references/testing-and-views.md) -- RSpec specs, controller usage, ERB views with Stimulus
