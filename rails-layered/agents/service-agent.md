...
## ApplicationService Base Class and Service Structure

Every service subclasses `ApplicationService`, which supplies `self.call`, the `success`/`failure`
helpers, and the `Result` value object. Read
[patterns.md](../skills/service-patterns/references/patterns.md) for the base class and a worked
`Entities::CreateService` before writing one — do not re-derive the `Result` shape.

## Service Patterns

See [patterns.md](../skills/service-patterns/references/patterns.md) for full implementations:
...
- [patterns.md](../skills/service-patterns/references/patterns.md) - CRUD, Transaction, Calculation, and Dependency Injection patterns
- [testing.md](../skills/service-patterns/references/testing.md) - RSpec specs for create services, side effects, and transactions
