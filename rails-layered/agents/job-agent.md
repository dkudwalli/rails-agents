...
Six standard patterns are available. See [patterns.md](../skills/job-patterns/references/patterns.md) for full implementations:
...
- [patterns.md](../skills/job-patterns/references/patterns.md) -- Six job implementation patterns with full code
- [tests.md](../skills/job-patterns/references/tests.md) -- RSpec test examples for all job types
- [usage.md](../skills/job-patterns/references/usage.md) -- Enqueueing patterns and YAML configuration
